...
exports.maskSnippet = maskSnippet;
exports.maskDetections = maskDetections;
exports.maskReport = maskReport;
/**
 ...
 */
function maskValue(value, ruleId) {
    if (!value) {
        return '****';
    }
    // Email detection
 ...
 */
function maskSnippet(snippet, ruleId, pattern) {
    if (!pattern) {
        return snippet;
    }
    try {
 ...
 */
function maskDetections(detections) {
